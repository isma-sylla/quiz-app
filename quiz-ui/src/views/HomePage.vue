  ...
  <div class="container mt-5 d-flex justify-content-between">
    ...
    <div class="scores-container flex-grow-1">
      <div class="welcome-container">
        <h1 class="mb-8 text-center text-uppercase display-4">Bienvenu dans le quiz!</h1>
        <button class="btn btn-lg btn-outline-dark " type="button" @click="$router.push('start-new-quiz-page')">Démarrer le quiz!</button>
      </div>
...
.container {
  ...
  align-items: flex-start; /* Assure que les conteneurs restent alignés en haut sur de petits écrans */
}
...
.welcome-container {
  flex: 1.5; /* Prend une portion plus grande pour plus de visibilité */
  padding: 20px;
  background-color: #f8f9fa; /* Couleur de fond pour mettre en avant la section */
  border: 2px solid black; /* Bordure pour renforcer le style Sketchy */
  box-shadow: 5px 5px 10px rgba(0,0,0,0.1); /* Ombre portée pour le relief */
  display: flex; /* Activation de Flexbox pour le centrage */
